...
internal class Day4KtTest {
  ...
  fun example1() {
    ...
    assertEquals(2, PassportScanner(input).validateNotNull())
  }
  ...
  fun example2Invalid() {
    ...
    assertEquals(0, PassportScanner(input).validateContents())
  }
  ...
  fun example2Valid() {
    ...
    assertEquals(4, PassportScanner(input).validateContents())
  }
