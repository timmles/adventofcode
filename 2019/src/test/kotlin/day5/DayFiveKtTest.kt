...
class DayFiveKtTest {
  ...
  @Test
  fun test() {
    assertEquals(11933517, IntCode(Common.getFile("day5.txt").readLines().first(), 1).output)
  }

  @Test
  fun test2() {
    assertEquals(10428568, IntCode(Common.getFile("day5.txt").readLines().first(), 5).output)
  }
